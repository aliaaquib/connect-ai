    ...
    <main>
      ...
      <section>
        <div className="flex items-center justify-center flex-col mt-[80px] gap-4 ">
          <span className="text-lightblue bg-lightblue/20 px-4 py-2 rounded-full text-sm">
          Connext is in development!
          </span>
          <Image
          ...
          />
          <p className="text-center max-w-[500px] text-lightblack">
            Your AI powered sales assistant! Embed Connext AI into any website
            with just a snippet of code!
          </p>
          <Button className="bg-lightblue font-bold text-white px-4">
            Coming Soon
          </Button>
          {/* <Image
      ...
      <div className="flex  justify-center gap-4 flex-wrap mt-6">
        {pricingCards.map((card) => (
          ...
          >
            <CardHeader>
              <CardTitle className="text-lightblue">{card.title}</CardTitle>
              <CardDescription>
            ...
            <CardFooter className="flex flex-col items-start gap-4">
              ...
              <Link
                ...
                className="bg-lightblue border-lightblue border-2 p-2 w-full text-center font-bold rounded-md"
              >
                Get Started
              </Link>
            </CardFooter>
